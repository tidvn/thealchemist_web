...
const ShowHidePwdInput = forwardRef((props, ref) => {
  ...
  return (
    <div className="relative">
      ...
      <button type="button" className="absolute top-3 right-4 bg-transparent flex items-center justify-center text-gray-700" onClick={toggleShowPwd}>
        {showPwd ?
...
export default ShowHidePwdInput
